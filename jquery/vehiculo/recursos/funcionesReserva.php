...
function insertarReserva($con, $id_vehiculo, $cedula, $can_asientos, $precio_reserva, $fecha_reserva, $fecha_vehiculo) {
    $insertar = $con->query("INSERT INTO reserva "
            ."(id_vehiculo_r, cedula_r, can_asientos, precio_reserva, fecha_reserva, fecha_vehiculo ) "
            . "VALUES('$id_vehiculo', '$cedula', '$can_asientos', '$precio_reserva', '$fecha_reserva', '$fecha_vehiculo')");
    return $insertar;
}

function actualizarReserva($con, $id_vehiculo, $id_cedula, $can_asientos, $precio_reserva, $fecha_reserva, $fecha_vehiculo, $idcedula) {
    $actualizar = $con->query("UPDATE reserva SET "
            ...
            . "fecha_vuelo =  '$fecha_vehiculo' WHERE cedula_r = '$idcedula'");
    return $actualizar;
}
...
function actualizarRegistro($con,$id_vehiculo,$res){
      $actualizar = $con->query("UPDATE vehiculo SET "
            . "can_disponible = '$res' WHERE id_vehculo = '$id_vehiculo'");
    return $actualizar;
}
