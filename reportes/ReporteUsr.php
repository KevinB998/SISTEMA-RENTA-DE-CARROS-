...
function Header()
{
    ...
    $this->Cell(80);
    // Título
    $this->Cell(30,10,'Vehiculo de reserva',0,0,'C');
    // Salto de línea
    $this->Ln(20);

    $this->Cell(20,10,'Num.', 1, 0, 'C', 0);
    $this->Cell(20,10,'Vehiculo', 1, 0, 'C', 0);
    ...
    $this->Cell(35,10,'Fech entrega', 1, 1, 'C', 0);
}
...
$consulta = "SELECT * FROM reserva WHERE cedula_r='$ced'";
...
// Creación del objeto de la clase heredada
    ...
    while ($fila = $resultado->fetch_assoc()) {
        ...
        $pdf->Cell(20,10,$fila['id_vehiculo_r'], 1, 0, 'C', 0);
        ...
        $pdf->Cell(35,10,$fila['fecha_entrega'], 1, 1, 'C', 0);
    }
